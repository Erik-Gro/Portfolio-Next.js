  ...
  return (
    <section className="c-space my-20" id="about">
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I love to build resposive and great looking UI's as well as building scallable and secure backends
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            <img src="assets/mohammad-rahmani-unsplash.jpg" alt="grid-2" className="w-full sm:h-[276px] h-fit object-contain" />
